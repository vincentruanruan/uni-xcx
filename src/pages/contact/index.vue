<template>
  <view class="contact">
    ...
    <!-- banner -->
    <div class="banner">
        <image class="bg" :src="banner" :mode="mode" ></image>
    </div>
    ...
    <div class="inner" v-if="show">
        ...
        <div class="qrcode">
            <image class="icon" :src="contact.erweima" :mode="mode" ></image>
            <div class="title">扫一扫 关注我</div>
        </div>
    </div>

        <!-- 地图 -->
    <view class="uni-common-mt" v-if="show">
        <view class="mapBg">
            <map class="map-box" :latitude="latitude" :longitude="longitude" :markers="covers" scale="14">
            </map>
        </view>
    </view>
